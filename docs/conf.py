...
htmlhelp_basename = 'clickhouse-sqlalchemydoc'
...
latex_documents = [
    (master_doc, 'clickhouse-sqlalchemy.tex',
     'clickhouse-sqlalchemy Documentation', author, 'manual'),
]
...
man_pages = [
    (master_doc, 'clickhouse-sqlalchemy',
     'clickhouse-sqlalchemy Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'clickhouse-sqlalchemy',
     'clickhouse-sqlalchemy Documentation', author, 'clickhouse-sqlalchemy',
